    ...
    <div class="chatbot-window" @click.stop>
      ...
      <div class="chatbot-header">
        <div class="header-left">
          <div class="robot-icon-small">
            <img src="/assets/Chat bot.png" alt="Robot">
          </div>
      ...
      <div class="chatbot-content">
        <div class="robot-image-container">
          <div class="robot-circle-large">
            <img src="/assets/Chat bot.png" alt="Chatbot Robot" class="robot-large">
          </div>
        </div>
      ...
      <div class="chatbot-input-bar">
        <div class="input-icons-left">
          <img src="/assets/mike.png" alt="Microphone" class="input-icon">
          <img src="/assets/image.png" alt="Image" class="input-icon">
        </div>
