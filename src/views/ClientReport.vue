  ...
  methods: {
    ...
    async submitForm() {
      ...
      try {
        ...
        // The backend does not support binary uploads, so if a file is selected
        // we just note its name in the description.
...
<style scoped>
.client-report-page { min-height: 100vh; background-color: #F5F5F5; padding-bottom: 50px; }
