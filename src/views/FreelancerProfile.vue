    ...
    <div class="profile-container">
      <div class="profile-sidebar">
        <div class="sidebar-profile-pic">
          <img :src="freelancer.avatar || '/assets/default-avatar.png'" :alt="freelancer.name" class="sidebar-profile-img">
        </div>
...
const freelancersDB = {
  'salma-mustafa': {
    ...
    avatar: '/assets/pexels kaplanart.jpg',
    skills: ['UI Design', 'UX Research', 'Figma', 'Adobe XD', 'HTML/CSS', 'Vue.js', 'Prototyping'],
    portfolio: [
      { title: 'E-commerce Dashboard', image: '/assets/portfolio1.png' },
      { title: 'Mobile Banking App', image: '/assets/portfolio2.png' },
      { title: 'Social Media Platform', image: '/assets/portfolio3.png' }
    ],
    rating: 4.8,
    review_count: 24,
    joined: 'January 2024',
  ...
  'mohamed-osama': {
    ...
    avatar: '/assets/pexels italo.jpg',
    skills: ['Node.js', 'React', 'AWS', 'Docker', 'MongoDB', 'PostgreSQL', 'CI/CD'],
    portfolio: [
      { title: 'SaaS Analytics Platform', image: '/assets/portfolio4.png' },
      { title: 'Real-time Chat App', image: '/assets/portfolio5.png' }
    ],
    rating: 4.9,
    review_count: 31,
    joined: 'March 2023',
  ...
  'nora-fahmy': {
    ...
    avatar: '/assets/pexels sadiq.jpg',
    skills: ['SEO', 'Google Ads', 'Content Strategy', 'Analytics', 'Social Media', 'Email Marketing'],
    portfolio: [
      { title: 'E-commerce SEO Campaign', image: '/assets/portfolio6.png' },
      { title: 'Brand Awareness Strategy', image: '/assets/portfolio7.png' }
    ],
    rating: 4.7,
    review_count: 18,
    joined: 'June 2023',
