  ...
  <div class="payment-page">
    ...
    <nav class="bg-white shadow-sm py-2">
      <div class="w-full px-4 flex items-center justify-between">
        <a class="flex items-center no-underline" href="#" @click.prevent="goBack">
          <span class="brand-s">S</span><span class="brand-killlink">killLink</span>
        </a>
        <div class="nav-icons-wrapper flex items-center gap-3">
          <div class="icon-with-badge">
            <img src="/assets/messages.png" alt="Chat" class="nav-icon" :class="{ active: showMessages }" @click="toggleMessages">
            <div class="badge-message" v-if="messageCount > 0">{{ messageCount }}</div>
          </div>
          <div class="icon-with-badge">
            <img src="/assets/notification.png" alt="Notifications" class="nav-icon" :class="{ active: showNotifications }" @click="toggleNotifications">
            <div class="badge-notification" v-if="notificationCount > 0">{{ notificationCount }}</div>
          </div>
          <div class="profile-pic" @click="goToProfile">
            <img :src="userAvatar || '/assets/pexels danx.jpg'" alt="Profile" class="rounded-full">
          </div>
          <img src="/assets/menu.png" alt="Menu" class="nav-icon menu-icon" :class="{ active: showMenu }" @click="toggleMenu">
        </div>
      </div>
    </nav>
    ...
    <div v-if="showMessages" class="messages-dropdown">
      <div class="message-item" v-for="msg in messagesList" :key="msg.id">
        <img :src="msg.avatar" alt="Client" class="message-avatar rounded-full">
    ...
    <div v-if="showNotifications" class="notifications-dropdown">
      <div class="notification-item" v-for="notif in notificationsList" :key="notif.id">
        <img :src="notif.avatar" alt="Client" class="notification-avatar rounded-full">
          ...
          <div class="payment-methods">
            ...
            <div class="payment-method">
              <div class="method-header" @click="toggleMethod('creditCard')">
                <div class="method-left">
                  <img src="/assets/credit card.png" alt="Credit Card" class="method-icon">
            ...
            <div class="payment-method">
              <div class="method-header" @click="toggleMethod('vodafone')">
                <div class="method-left">
                  <img src="/assets/vodafone.png" alt="Vodafone" class="method-icon">
            ...
            <div class="payment-method">
              <div class="method-header" @click="toggleMethod('fawry')">
                <div class="method-left">
                  <img src="/assets/fawry.png" alt="Fawry" class="method-icon">
            ...
            <div class="payment-method">
              <div class="method-header" @click="toggleMethod('instapay')">
                <div class="method-left">
                  <img src="/assets/Instapay.png" alt="Instapay" class="method-icon">
...
export default {
  ...
  data() {
    return {
      ...
      // Dropdowns Data
      messagesList: [
        { id: 1, name: 'Rana Hany', avatar: '/assets/client3.jpg', text: 'Rana: The money will be in your wallet within minutes.', time: '1 h' },
        { id: 2, name: 'Hazem Ehab', avatar: '/assets/client1.jpg', text: 'Hazem: Thanks, I\'ll give you 5 stars.', time: '2 h' },
        { id: 3, name: 'Ahmed Khairy', avatar: '/assets/client6.jpg', text: 'You: I can finish this task in less time than requested.', time: '4 h' }
      ],
      notificationsList: [
        { id: 1, name: 'Rana Hany', avatar: '/assets/client3.jpg', text: 'has sent your payment', time: '1 hour ago' },
        { id: 2, name: 'Hazem Ehab', avatar: '/assets/client1.jpg', text: 'rated you 5 stars', time: '2 hours ago' },
        { id: 3, name: 'Rana Hany', avatar: '/assets/client3.jpg', text: 'approved your offer', time: '2 days ago' }
      ]
    }
  },
  ...
  methods: {
    ...
    async processPayment(method) {
      ...
      try {
        ...
        // Call the backend, which runs the charge through the mock gateway.
        await clientAPI.topUpWallet(paymentData)
        ...
        // Show the real reason from the gateway (e.g. "Card was declined").
        // Tip for demos: card 4000 0000 0000 0002 is always declined.
        this.paymentError =
          err.response?.data?.message || 'Could not process the payment. Please try again.'
      } finally {
