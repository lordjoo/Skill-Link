    ...
    <div class="container py-5 px-4">
      <div class="create-post mb-5">
        <div class="input-wrapper">
          <img src="/assets/Headshot profile.jpg" alt="Student" class="user-avatar">
...
export default {
  ...
  data() {
    return {
      showChatbot: false,
      posts: [
        { author: 'Omar Sultan', avatar: '/assets/Omar.jpg', text: 'Hey everyone, has anyone worked on an SEO article project before? The client wants 10 articles per week is that realistic or too much? Any tips would be appreciated', comments: 3 },
        { author: 'Salma Sameh', avatar: '/assets/Salma.jpg', text: 'Why do you think some proposals get accepted while others don\'t, even when the service is the same? Is it about skills, the proposal style, or timing? Anyone had a similar experience ?', comments: 6 }
      ]
    }
  },
  methods: {
...
<style scoped>
.community-page { min-height: 100vh; background-color: #F5F5F5; padding-bottom: 50px; }
